package com.secure.service.demo.config;
...
@Configuration
@EnableMongoRepositories("com.secure.service.demo.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("com.secure.service.demo.config.dbmigrations");
